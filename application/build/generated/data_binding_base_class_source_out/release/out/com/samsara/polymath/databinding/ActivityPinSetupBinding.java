...
public final class ActivityPinSetupBinding implements ViewBinding {
  ...
  private ActivityPinSetupBinding(@NonNull ConstraintLayout rootView,
      @NonNull TextView appNameTextView, @NonNull MaterialButton btn0, @NonNull MaterialButton btn1,
      ...
      @NonNull MaterialButton btn8, @NonNull MaterialButton btn9,
      @NonNull MaterialButton btnBackspace, @NonNull TextView errorTextView,
      @NonNull TextView instructionTextView, @NonNull View pinDot1, @NonNull View pinDot2,
      @NonNull View pinDot3, @NonNull View pinDot4, @NonNull LinearLayout pinDotsLayout,
      @NonNull GridLayout pinPadGrid, @NonNull MaterialButton skipButton,
  ...
  public static ActivityPinSetupBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityPinSetupBinding((ConstraintLayout) rootView, appNameTextView, btn0, btn1,
          btn2, btn3, btn4, btn5, btn6, btn7, btn8, btn9, btnBackspace, errorTextView,
          instructionTextView, pinDot1, pinDot2, pinDot3, pinDot4, pinDotsLayout, pinPadGrid,
          skipButton, titleTextView);
    }
