...
@Database(entities = [Persona::class, Task::class, Comment::class, PersonaStatistics::class, Tag::class, PersonaTag::class, TimeEntry::class, PersonaOpenEvent::class], version = 21, exportSchema = false)
