...
@Database(entities = [Persona::class, Task::class, Comment::class, PersonaStatistics::class, Tag::class, PersonaTag::class, PersonaOpenEvent::class, DailyCompletion::class], version = 24, exportSchema = false)
